...
export default function RaffleApp() {
  ...
  useEffect(() => {
    if (!(isAdmin && adminTab === 'draw' && !((data && data.winner)))) return;
  ...
  }, [entries, theme, isAdmin, adminTab, data && data.winner]);
          ...
          <div style={styles.heroTop}>
            ...
            <div style={{ display: 'flex', gap: 8 }}>
              ...
              {isAdmin ? (
                ...
                <button style={styles.iconBtn} onClick={() => setShowPinModal(true)} aria-label="ورود مدیر" title="ورود مدیر">
        ...
        {isAdmin && (
          <div style={styles.tabBar}>
            <button
              ...
              onClick={() => { sound.playClick(); setAdminTab('draw'); }}
            >
              <Disc3 size={15} />
              <span>قرعه‌کشی</span>
            </button>
            <button
              ...
              onClick={() => { sound.playClick(); setAdminTab('entries'); }}
            >
              <UserPlus size={15} />
